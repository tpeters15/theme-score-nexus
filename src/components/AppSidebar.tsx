...
import { Home, Target, Zap, FileText, Settings, Shield, Radar, ListChecks, Database, Presentation } from "lucide-react";
...
const mainItems = [
  ...
  { title: "Executive Summary", url: "/executive-summary", icon: Presentation },
